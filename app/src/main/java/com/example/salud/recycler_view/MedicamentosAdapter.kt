...
import kotlinx.android.synthetic.main.activity_prueba.view.*
...
//        }
        ...
        holder.itemView.setOnLongClickListener {
            ...
            Toast.makeText(holder.itemView.context,"Haz seleccionado el medicamento ${Singleton.dataSet.get(position).medicamento}",Toast.LENGTH_LONG).show()
            true
        }
